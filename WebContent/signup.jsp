...
<body>
	...
	<div class="main-contents">
		...
		<form action="signup" method="post">
			...
			(名前はあなたの公開プロフィールに表示されます)<br /> <label for="account">アカウント名</label> <input
				name="account" id="account" />（あなたの公開プロフィール: http://
			localhost:8080/?account=アカウント名）<br /> <label for="password">パスワード</label>
